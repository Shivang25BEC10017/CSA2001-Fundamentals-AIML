...
# 1. Setup & Config
st.set_page_config(page_title="Sharp-Timer", page_icon="⌛", layout="centered")
...
# 3. Header & Metrics
st.title("⌛ Sharp-Timer")
col1, col2, col3 = st.columns(3)
col1.metric("Phase", st.session_state.current_phase)
col2.metric("Cycle Progress", f"{st.session_state.sessions_completed % 2}/2")
